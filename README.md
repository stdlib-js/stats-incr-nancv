...
```javascript
incrnancv = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-incr-nancv@umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var incrnancv = require( 'path/to/vendor/umd/stats-incr-nancv/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-incr-nancv@umd/browser.js"></script>
```
...
Returns an accumulator `function` which incrementally computes the [coefficient of variation][coefficient-of-variation], ignoring `NaN` values.
...
-   Input values are **not** type checked. Unlike `incrcv`, `NaN` values are ignored and do not affect the accumulated value.
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/stats-incr-nancv.svg
[npm-url]: https://npmjs.org/package/@stdlib/stats-incr-nancv

[test-image]: https://github.com/stdlib-js/stats-incr-nancv/actions/workflows/test.yml/badge.svg?branch=main
[test-url]: https://github.com/stdlib-js/stats-incr-nancv/actions/workflows/test.yml?query=branch:main

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/stats-incr-nancv/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/stats-incr-nancv?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/stats-incr-nancv.svg
[dependencies-url]: https://david-dm.org/stdlib-js/stats-incr-nancv/main
...
[deno-url]: https://github.com/stdlib-js/stats-incr-nancv/tree/deno
[deno-readme]: https://github.com/stdlib-js/stats-incr-nancv/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/stats-incr-nancv/tree/umd
[umd-readme]: https://github.com/stdlib-js/stats-incr-nancv/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/stats-incr-nancv/tree/esm
[esm-readme]: https://github.com/stdlib-js/stats-incr-nancv/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/stats-incr-nancv/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/stats-incr-nancv/main/LICENSE
